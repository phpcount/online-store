...
import { concatUrlByParams, getUrlViewProduct } from '../../../../utils/url-generator'
...
export default {
    ...
    computed: {
        ...
        urlShowProduct() {
            return getUrlViewProduct(this.staticStore.url.viewProduct, this.cartProduct.product.uuid);
        },
        productImage() {
            const productImages = this.cartProduct.product.productImages;

            return Array.isArray(productImages) && productImages.length ? productImages[0] : null;
        }
    },
    methods: {
